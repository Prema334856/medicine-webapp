    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="cart-item">
                <div class="row">
                    <div class="col-md-3">
                        <img src="img/product-4.webp" class="img-fluid" alt="Product">
                    </div>
                    <div class="col-md-5">
                        <h4>Napa</h4>
                        <p>৳ <span class="price">1.08</span></p>
                    </div>
                    <div class="col-md-2">
        ...
        <div class="col-md-4">
            ...
            <div class="border p-3 mb-3">
                ...
                <div class="d-flex justify-content-between">
                    <span>Subtotal</span>
                    <span class="subtotal">৳ 1.08 </span>
                </div>
                <div class="d-flex justify-content-between">
                    <span>Tax</span>
                    <span class="tax">৳ .30</span>
                </div>
                <div class="d-flex justify-content-between">
                <script type="module" src=""></script>    <span>Total</span>
                    <span class="total">৳ 1.08 </span>
                </div>
                <a href="gw.php"><button class="btn btn-warning w-100 mt-3">Proceed to Checkout</button></a><br><br><br>
            </div>
        </div>
    </div>
</section>
...
<script>
    ...
    quantities.forEach((quantity, index) => {
        quantity.addEventListener('input', () => {
            ...
            // Calculate tax
            const tax = 0.30 * qty; // Just a sample tax calculation
            ...
            taxes[index].textContent = `৳ ${tax.toFixed(2)}`;
...
<script>
    ...
    function removeCartItem(button) {
        ...
        if (cartItems.length === 0) {
            // If no items left, remove cart summary
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateCartSummary() {
            // Implement your logic to update the cart summary here
        }
    });
</script>
